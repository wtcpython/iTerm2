...
- (NSString *)it_description {
    ...
    [s appendFormat:@"%@ frame=%@ hidden=%@ alphaValue=%0.2f autoresizing=%@ autolayout=%@ %@tracking_areas=%@",
     ...
     self.translatesAutoresizingMaskIntoConstraints ? NSLocalizedString(@"No", @"UI") : [NSString stringWithFormat:@"*AUTO LAYOUT IN EFFECT* intrinsicContentSize=%@", NSStringFromSize(self.intrinsicContentSize)],
     detail,
