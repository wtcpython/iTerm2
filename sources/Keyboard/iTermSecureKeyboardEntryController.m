...
- (void)showMontereyWarning NS_AVAILABLE_MAC(12_0) {
    ...
    [iTermWarning showWarningWithTitle:NSLocalizedString(@"Secure keyboard entry is enabled.\n\nIn macOS 12 and later, enabling Secure Keyboard Entry prevents other programs from being activated. This affects the `open` command as well as the panel shown when using Touch ID for sudo.", @"UI")
