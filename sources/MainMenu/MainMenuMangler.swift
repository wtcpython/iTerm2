...
class MainMenuMangler: NSObject {
    ...
    private let iconMap = [
        ...
        NSLocalizedString("Close", comment: "UI"): "xmark",
        ...
        "Cut": "scissors",
        NSLocalizedString("Copy", comment: "UI"): "document.on.document",
        ...
        NSLocalizedString("Suppressed Alerts", comment: "UI"): "bell.badge",
        ...
        NSLocalizedString("Make Screenshot", comment: "UI"): "camera",
        ...
        NSLocalizedString("Reveal in Finder", comment: "UI"): "folder.circle",
