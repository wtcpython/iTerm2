...
- (NSArray<iTermStatusBarComponentKnob *> *)statusBarComponentKnobs {
    ...
    [[iTermStatusBarComponentKnob alloc] initWithLabelText:NSLocalizedString(@"Show Percentage", @"Status bar knob")
    ...
    [[iTermStatusBarComponentKnob alloc] initWithLabelText:NSLocalizedString(@"Show Estimated Time", @"Status bar knob")
                                                      type:iTermStatusBarComponentKnobTypeCheckbox
                                               placeholder:nil
                                              defaultValue:@NO
...
- (NSString *)statusBarComponentShortDescription {
    return NSLocalizedString(@"Battery Level", @"UI");
}

- (NSString *)statusBarComponentDetailedDescription {
    return NSLocalizedString(@"Shows current battery level and its recent history.", @"UI");
}
