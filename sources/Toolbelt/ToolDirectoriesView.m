...
- (instancetype)initWithFrame:(NSRect)frame {
    ...
    if (self) {
        ...
        if (@available(macOS 10.16, *)) {
            ...
            clear_.bordered = NO;
            clear_.image = [NSImage it_imageForSymbolName:SFSymbolGetString(SFSymbolTrash) accessibilityDescription:NSLocalizedString(@"Clear", @"UI")];
...
- (void)clear:(id)sender {
    ...
    alert.messageText = NSLocalizedString(@"Erase Saved Directories?", @"UI");
